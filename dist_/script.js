...
/* harmony import */ var _modules_sliders_sliders__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/sliders/sliders */ "./src/js/modules/sliders/sliders.js");
/* harmony import */ var _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders/slider-main */ "./src/js/modules/sliders/slider-main.js");
...
/* harmony import */ var _modules_videoplayers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/videoplayers */ "./src/js/modules/videoplayers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var mainSlider = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
    btns: '.next',
    container: '.page'
  });
  var miniSlider = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  var player = new _modules_videoplayers__WEBPACK_IMPORTED_MODULE_3__["default"]('.play', '.overlay');
  var form = new _modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"]('.form', 'assets/question.php'); //const diff = new Difference();
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(parentSelector, items, counter) {
      parentSelector.querySelector('.plus').addEventListener('click', function () {
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function sendForm(url, data) {
      var res;
      return regeneratorRuntime.async(function sendForm$(_context) {
        while (1) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        return form.addEventListener('submit', function (evt) {
          ...
          _this.sendForm(_this.path, formData).then(function (res) {
            console.log(res);
...
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sliders */ "./src/js/modules/sliders/sliders.js");
...
function (_Sliders) {
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          _this.plusSlides(1); //console.log('click');
  ...
  return MainSlider;
}(_sliders__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
/***/ "./src/js/modules/sliders/sliders.js":
/*!*******************************************!*\
  !*** ./src/js/modules/sliders/sliders.js ***!
  \*******************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/videoplayers.js":
/*!****************************************!*\
  !*** ./src/js/modules/videoplayers.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VideoPlayers; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function VideoPlayers(triggers, popup) {
    _classCallCheck(this, VideoPlayers);
  ...
  _createClass(VideoPlayers, [{
    ...
    value: function createPlayer(url) {
      ...
      this.player = new YT.Player('frame', {
        height: '100%',
        width: '100%',
        videoId: "".concat(url) //videoId: 'M7lc1UVf-VE',
